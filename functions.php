<?php
	...
	function remove_alone_actions() {
		...
		if ( ! is_user_logged_in() ) {
			...
			// Winkelmandknop nu pas weer toevoegen (vermijd 'lees verder'-knop bij niet-ingelogden)
	...
	// Toon metaboxes voor voeding- en wijninfo enkel bij bepaalde productcategorieën
