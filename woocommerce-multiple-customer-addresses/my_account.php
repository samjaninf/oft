...
<h4 class="wcmca_additional_addresses_list_title wcmca_shipping_addresses_title"><?php _e( 'Gekoppelde verzendadressen','oft' ); ?></h4>
			...
			<div class="col-<?php echo $col_counter;?> address">
				<header class="wcmcam_address_block_title">
					...
					<<?php echo $default_addresses_style['my_account_page_addresses_title_tag']; ?> class="wcmca_address_title" id="wcmca_field_name_<?php echo $address_id;?>">
						<input class="wcmca_address_title_checkbox wcmca_address_<?php echo $type;?>_title_checkbox" type="checkbox" <?php if(isset($user_id)) echo 'data-user-id="'.$user_id.'"';?> data-id="<?php echo $address_id;?>" data-type="<?php echo $address['type']; ?>"><span class="wcmca_address_title_text_content"><?php echo $address['address_internal_name']; ?></span></input>
					</<?php echo $default_addresses_style['my_account_page_addresses_title_tag']; ?>>
					<?php if(!isset($type_to_show_in_order_edit_page) ): 
							if(is_admin() || !$field_managment_options['disable_user_'.$address['type'].'_addresses_editing_capabilities']): ?>
