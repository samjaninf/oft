...
<div class="wrap">
	...
	<p>Elke werkdag gaat er om 14 uur een script van start dat nieuwe / gewijzigde beelden in <a href="file:///\\vmfile\data\1-Vormgeving & Publicaties\OFT-sync (LATEN STAAN)\RGB HI-RES\">F:\1-Vormgeving & Publicaties\OFT-sync (LATEN STAAN)\RGB HI-RES\</a> uploadt naar de OFT-site. Daarna dienen de beelden nog geregistreerd te worden in de mediabib. Hieronder zie je een lijstje met alle originelen die sinds de laatste fotoregistratie in de uploads-map geplaatst werden. De meest recente bestanden staan onderaan. Om de thumbnails aan te maken en de foto's te registreren in de mediabib dient een sitebeheerder daarna nog op onderstaande knop te klikken. Foto's kunnen hierbij niet dubbel geüpload worden. Sluit dit venster niet zolang de achtergrond oranje is!</p>

	<p>Bijgewerkte foto's (betere kwaliteit, correcte product, ...) worden meteen weer aan het product gekoppeld waar de vorige versie al aan gelinkt was. Nieuwe hoofdbeelden worden automatisch gelinkt op basis van het artikelnummer, op voorwaarde dat het product al bestaat. Is er een foutje gebeurd of wil je een bepaalde foto definitief verwijderen? Dan dien je de foto zowel te verwijderen <a href="<?php echo site_url('/wp-admin/upload.php'); ?>">uit de mediabibliotheek</a> als uit <a href="file:///\\vmfile\data\1-Vormgeving & Publicaties\OFT-sync (LATEN STAAN)\RGB HI-RES\">F:\1-Vormgeving & Publicaties\OFT-sync (LATEN STAAN)\RGB HI-RES\</a>. Zo niet zal de foto elke middag weer als 'nieuwe' foto opduiken. De synchronisatie werkt immers niet in twee richtingen, maar enkel opwaarts richting webserver!</p>

	<p>Raadpleeg het overzicht met alle packshots van actuele producten op <a href="<?php echo get_stylesheet_directory_uri().'/packshots.php'; ?>" target="_blank">deze handige pagina</a> (opgepast: laadtijd +/- 30 seconden!). De thumbnails op het formaat 300 x 300 pixels worden de volgende werkdag automatisch gesynchroniseerd met de map op de Combell-server waar BestelWeb zijn packshots haalt. En zo is iedereen blij!</p>
