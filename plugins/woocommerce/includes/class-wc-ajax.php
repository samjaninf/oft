...
class WC_AJAX {
	...
	public static function add_to_cart() {
		...
		// GEWIJZIGD: Werp géén error op bij private producten!
		if ( $passed_validation && false !== WC()->cart->add_to_cart( $product_id, $quantity, $variation_id, $variation ) && ( 'publish' === $product_status or 'private' === $product_status ) ) {
